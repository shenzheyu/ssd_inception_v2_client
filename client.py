...
def parse_result(result_future):
    ...
    boxes = result_future.outputs['detection_boxes']
    scores = result_future.outputs['detection_scores']
    labels = result_future.outputs['detection_classes']
    num_detections = result_future.outputs['num_detections']
